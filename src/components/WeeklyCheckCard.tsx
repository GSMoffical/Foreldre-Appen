...
export function WeeklyCheckCard({ totalActivities, collisionCount }: WeeklyCheckCardProps) {
  ...
  return (
    <div className="mx-4 mt-2 rounded-xl border border-zinc-200 bg-white px-3 py-2.5 shadow-soft">
      <p className="text-caption font-semibold uppercase tracking-wide text-zinc-500">Ukesjekk</p>
      <p className="mt-1 text-body-sm font-medium text-zinc-800">
