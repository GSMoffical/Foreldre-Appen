  ...
  return (
    <div className="flex min-h-0 w-full min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <div className="flex shrink-0 items-center gap-2 bg-synkaCream border-b border-synkaNavy/8 px-4 py-3">
        ...
        <SectionDots />
        <h2 className="text-heading font-semibold text-synkaNavy">Hjelp</h2>
      </div>
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-y-auto overscroll-y-contain [-webkit-overflow-scrolling:touch]">
        <div className="flex flex-col gap-3 px-4 pt-5 pb-10">
          ...
          <div className="rounded-md border border-synkaNavy/8 bg-white p-4">
            <p className="text-caption font-semibold uppercase tracking-wide text-synkaNavy/40">Kom i gang</p>
            <button
              type="button"
            ...
            >
              <span className="text-body font-medium text-synkaNavy">Vis gjennomgang på nytt</span>
          ...
          {/* Om Synka */}
          <div className="rounded-md border border-synkaNavy/8 bg-white p-4">
            <p className="text-caption font-semibold uppercase tracking-wide text-synkaNavy/40">Om Synka</p>
            <div className="mt-3 flex items-center gap-3 px-1">
              <img src="/synka-mark.svg" alt="" className="h-10 w-10 shrink-0" aria-hidden />
              <div className="min-w-0 flex-1">
                <p className="text-body font-semibold text-synkaNavy">Synka</p>
                <p className="text-caption text-synkaNavy/50">Versjon {APP_VERSION}</p>
              </div>
            </div>
            <p className="mt-3 px-1 text-label leading-relaxed text-synkaNavy/50">
      ...
      {toast && (
        ...
        >
          <div className="rounded-lg bg-synkaNavy px-4 py-2.5 text-body-sm font-medium text-white shadow-lg">
            Kommer snart
          </div>
        </div>
      )}
