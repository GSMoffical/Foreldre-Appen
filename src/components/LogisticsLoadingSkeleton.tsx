    ...
    <div className="flex flex-1 min-h-0 flex-col px-3 pb-4" aria-busy="true" aria-label="Laster logistikk">
      <div className="flex-1 overflow-hidden flex flex-col">
        <div className="border-b border-zinc-100 px-4 pt-4 pb-3">
          <div className="h-6 w-32 animate-pulse rounded-md bg-zinc-200" />
          <div className="mt-2 h-4 w-48 animate-pulse rounded bg-zinc-100" />
          <div className="mt-4 flex flex-wrap gap-2">
            <div className="h-8 w-24 animate-pulse rounded-pill bg-zinc-100" />
            <div className="h-8 w-20 animate-pulse rounded-pill bg-zinc-100" />
          </div>
        </div>
          ...
          {[1, 2, 3].map((section) => (
            <div key={section} className="space-y-2">
              ...
              <div className="space-y-2">
                <div className="h-[72px] w-full animate-pulse rounded-lg bg-zinc-100" />
                <div className="h-[72px] w-full animate-pulse rounded-lg bg-zinc-100" style={{ width: '92%' }} />
              </div>
            </div>
          ))}
        </div>
