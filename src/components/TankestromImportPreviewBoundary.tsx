...
const Fallback = () => (
  <div className="rounded-lg border border-rose-200 bg-rose-50 p-4 text-center">
    <p className="text-body-sm font-medium text-rose-900">Kunne ikke vise forhåndsvisningen.</p>
    <p className="mt-1 text-caption text-rose-800">Lukk vinduet og prøv igjen, eller last siden på nytt.</p>
  </div>
)
